...
Revision ID: 73a121a515be
Revises: 
Create Date: 2023-12-11 18:55:45.842130
...
def upgrade():
    ...
    op.create_table('legacy_part',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('quantity', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['id'], ['part.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
